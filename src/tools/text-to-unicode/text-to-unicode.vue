...
<template>
  <c-card :title="$t('tools.text-to-unicode.textToUnicodeTitle')">
    <c-input-text
      ...
      multiline
      :placeholder="$t('tools.text-to-unicode.textToUnicodeInputPlaceholder')"
      :label="$t('tools.text-to-unicode.textToUnicodeInputLabel')"
      autosize
      autofocus
      raw-text
    ...
    <c-input-text
      ...
      :label="$t('tools.text-to-unicode.textToUnicodeOutputLabel')"
      multiline
      raw-text
      readonly
      mt-2
      :placeholder="$t('tools.text-to-unicode.textToUnicodeOutputPlaceholder')"
  ...
  <c-card :title="$t('tools.text-to-unicode.unicodeToTextTitle')">
    <c-input-text
      ...
      :label="$t('tools.text-to-unicode.unicodeToTextInputLabel')"
      autosize
      raw-text
    ...
    <c-input-text
      ...
      :label="$t('tools.text-to-unicode.unicodeToTextOutputLabel')"
      multiline
      raw-text
      readonly
      mt-2
      :placeholder="$t('tools.text-to-unicode.unicodeToTextOutputPlaceholder')"
