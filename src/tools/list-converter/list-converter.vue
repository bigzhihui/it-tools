    ...
    <div style="margin: 0 auto; max-width: 600px">
      <c-card>
        <div flex>
          <div>
            <n-form-item
              :label="$t('tools.list-converter.trimItems')"
            ...
            <n-form-item
              :label="$t('tools.list-converter.removeDuplicates')"
              label-placement="left"
              label-width="170"
              :show-feedback="false"
              mb-2
            ...
            <n-form-item
              :label="$t('tools.list-converter.lowerCase')"
              label-placement="left"
              label-width="170"
              :show-feedback="false"
              mb-2
            ...
            <n-form-item
              :label="$t('tools.list-converter.keepLineBreaks')"
              label-placement="left"
              label-width="170"
              :show-feedback="false"
              mb-2
          ...
          <div flex-1>
            ...
            <n-form-item
              :label="$t('tools.list-converter.wrapItem')"
              label-placement="left"
              label-width="120"
              :show-feedback="false"
              mb-2
            ...
            <n-form-item
              :label="$t('tools.list-converter.wrapList')"
              label-placement="left"
              label-width="120"
              :show-feedback="false"
              mb-2
