...
<template>
  <div style="flex: 0 0 100%">
    <div style="margin: 0 auto; max-width: 600px" flex justify-center gap-3>
      <n-form-item :label="t('tools.json-prettify.sortKeys')" label-placement="left" label-width="120">
        <n-switch v-model:value="sortKeys" />
      </n-form-item>
      <n-form-item :label="t('tools.json-prettify.indentSize')" label-placement="left" label-width="120" :show-feedback="false">
  ...
  <n-form-item :label="t('tools.json-prettify.prettifiedJson')">
