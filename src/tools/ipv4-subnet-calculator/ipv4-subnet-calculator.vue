...
const sections = computed<{
  ...
  undefinedFallback?: string
      ...
      },
      {
        ...
        undefinedFallback: t('tools.ipv4-subnet-calculator.sections.noBroadcastFallback'),
      },
      {
        label: t('tools.ipv4-subnet-calculator.sections.ipClass'),
        getValue: ({ base: ip }) => getIPClass({ ip }),
        undefinedFallback: t('tools.ipv4-subnet-calculator.sections.unknownClassFallback'),
      },
    ]);
