...
const encryptionOptions = computed(() => [
  {
    label: t('tools.wifi-qr-code-generator.noPassword'),
    value: 'nopass',
  },
  {
    label: 'WPA/WPA2',
    ...
    <div grid grid-cols-1 gap-12>
      <div>
        <c-select
          ...
          mb-4
          :label="$t('tools.wifi-qr-code-generator.encryptionMethod')"
          default-value="WPA"
          label-position="left"
          label-width="130px"
          label-align="right"
        ...
        <div class="mb-6 flex flex-row items-center gap-2">
          <c-input-text
            ...
            label-width="130px"
            label-align="right"
            :label="$t('tools.wifi-qr-code-generator.ssid')"
            rows="1"
            autosize
        ...
        <c-input-text
          ...
          label-width="130px"
          label-align="right"
          :label="$t('tools.wifi-qr-code-generator.password')"
          rows="1"
          autosize
          type="password"
        ...
        <c-select
          ...
          :label="$t('tools.wifi-qr-code-generator.eapMethod')"
          label-position="left"
          label-width="130px"
          label-align="right"
        ...
        <div v-if="encryption === 'WPA2-EAP'" class="mb-6 flex flex-row items-center gap-2">
          <c-input-text
            ...
            label-width="130px"
            label-align="right"
            :label="$t('tools.wifi-qr-code-generator.identity')"
            rows="1"
            autosize
        ...
        <c-select
          ...
          :label="$t('tools.wifi-qr-code-generator.eapPhase2Method')"
          label-position="left"
          label-width="130px"
          label-align="right"
      ...
      <div v-if="qrcode">
        <div flex flex-col items-center gap-3>
          ...
          <c-button @click="download">
            {{ $t('tools.wifi-qr-code-generator.downloadQrCode') }}
          </c-button>
        </div>
      </div>
    </div>
