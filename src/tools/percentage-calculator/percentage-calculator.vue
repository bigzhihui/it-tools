...
<template>
  <div style="flex: 0 0 100%">
    <div style="margin: 0 auto; max-width: 600px">
      <c-card mb-3>
        <div mb-3 sm:hidden>
          {{ $t('tools.percentage-calculator.card1.whatIs') }}
        </div>
        <div flex gap-2>
          ...
          <div min-w-fit pt-1>
            {{ $t('tools.percentage-calculator.card1.percentOf') }}
          </div>
          ...
          <input-copyable
            ...
            readonly
            :placeholder="$t('tools.percentage-calculator.result')"
      ...
      <c-card mb-3>
        <div mb-3>
          {{ $t('tools.percentage-calculator.card3.title') }}
        </div>
        <div flex gap-2>
          <n-input-number v-model:value="numberFrom" data-test-id="numberFrom" :placeholder="$t('tools.percentage-calculator.card3.from')" />
          <n-input-number v-model:value="numberTo" data-test-id="numberTo" :placeholder="$t('tools.percentage-calculator.card3.to')" />
          <input-copyable
