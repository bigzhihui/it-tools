...
<template>
  <div style="flex: 0 0 100%">
    <div style="margin: 0 auto; max-width: 600px" flex justify-center gap-3>
      <n-form-item :label="$t('tools.yaml-prettify.sortKeys')" label-placement="left" label-width="160">
        <n-switch v-model:value="sortKeys" />
      </n-form-item>
      <n-form-item :label="$t('tools.yaml-prettify.indentSize')" label-placement="left" label-width="120" :show-feedback="false">
  ...
  <n-form-item
    :label="$t('tools.yaml-prettify.rawYaml')"
  ...
  <n-form-item :label="$t('tools.yaml-prettify.prettifiedYaml')">
