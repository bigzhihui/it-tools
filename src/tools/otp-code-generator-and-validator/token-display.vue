  ...
  <div>
    <div mb-5px w-full flex items-center>
      <div flex-1 text-left>
        {{ t('tools.otp-generator.display.previous') }}
      </div>
      <div flex-1 text-center>
        {{ t('tools.otp-generator.display.current') }}
      </div>
      <div flex-1 text-right>
        {{ t('tools.otp-generator.display.next') }}
      </div>
    </div>
    <div flex items-center>
      <c-tooltip :tooltip="previousCopied ? t('tools.otp-generator.display.copied') : t('tools.otp-generator.display.copyPrevious')" position="bottom" flex-1>
      ...
      <c-tooltip :tooltip="currentCopied ? t('tools.otp-generator.display.copied') : t('tools.otp-generator.display.copyCurrent')" position="bottom" flex-1 flex-basis-5xl>
        <c-button
      ...
      <c-tooltip :tooltip="nextCopied ? t('tools.otp-generator.display.copied') : t('tools.otp-generator.display.copyNext')" position="bottom" flex-1>
