...
const indentStyleOptions = computed(() => [
  { label: t('tools.sql-prettify.indentStyles.standard'), value: 'standard' },
  { label: t('tools.sql-prettify.indentStyles.tabularLeft'), value: 'tabularLeft' },
  { label: t('tools.sql-prettify.indentStyles.tabularRight'), value: 'tabularRight' },
]);
